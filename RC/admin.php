...
?>
<?php
 $c_categorie     = count_by_id('ubicaciones');
     ...
     <div class="panel panel-default">
       <div class="panel-heading">
         <strong>
           ...
           <span>Productos más sacados</span>
         </strong>
       </div>
      ...
      <?php foreach ($recent_products as  $recent_product): ?>
            <a class="list-group-item clearfix" href="edit_product.php?id=<?php echo    (int)$recent_product['id'];?>">
                ...
                <?php echo remove_junk(first_character($recent_product['nombre']));?>
                 ...
                 $<?php echo (int)$recent_product['venta_precio']; ?>
                  </span>
                </h4>
                <span class="list-group-item-text pull-right">
                <?php echo remove_junk(first_character($recent_product['ubicaciones'])); ?>
              </span>
          </a>
      <?php endforeach; ?>
    </div>
