...
<?php
  if(isset($_POST['submit'])){
    ...
    if(empty($errors)):
      ...
      $results      = find_buy_by_dates($start_date,$end_date);
    else:
      $session->msg("d", $errors);
      redirect('buy_report.php', false);
    endif;
...
<body>
        ...
        <tbody>
          <?php foreach($results as $result): ?>
           <tr>
              ...
              <td class="text-right"><?php echo remove_junk($result['compra_precio']);?></td>
              <td class="text-right"><?php echo remove_junk($result['venta_precio']);?></td>
  ...
  <?php
        ...
        $session->msg("d", "No se encontraron entradas. ");
        redirect('buy_report.php', false);
     endif;
  ?>
</body>
