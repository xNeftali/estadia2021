...
if(isset($_POST['edit_cat'])){
  ...
  if(empty($errors)){
        $sql = "UPDATE ubicaciones SET nombre='{$cat_name}'";
     ...
     <div class="panel panel-default">
       <div class="panel-heading">
         <strong>
           ...
           <span>Editando ubicacion <?php echo remove_junk(ucfirst($categorie['nombre']));?></span>
        </strong>
       </div>
       <div class="panel-body">
         <form method="post" action="edit_categorie.php?id=<?php echo (int)$categorie['id'];?>">
           ...
           <button type="submit" name="edit_cat" class="btn btn-primary">Actualizar ubicacion</button>
       </form>
       </div>
     </div>
   </div>
