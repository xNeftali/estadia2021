...
$all_categories = find_all('ubicaciones');
...
<?php
 if(isset($_POST['product'])){
   ...
   if(empty($errors)){
       ...
       $query  .=" compra_precio ='{$p_buy}', venta_precio ='{$p_sale}', categoria_id ='{$p_cat}',media_id='{$media_id}'";
                 ...
                 <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" class="form-control" name="buying-price" value="<?php echo remove_junk($product['compra_precio']);?>">
                  ...
                  <div class="col-md-4">
                   <div class="form-group">
                     ...
                     <div class="input-group">
                       ...
                       <input type="number" class="form-control" name="saleing-price" value="<?php echo remove_junk($product['venta_precio']);?>">
                       <span class="input-group-addon">.00</span>
                    </div>
                   </div>
                  </div>
