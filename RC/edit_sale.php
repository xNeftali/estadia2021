  ...
  if(isset($_POST['update_sale'])){
    ...
    validate_fields($req_fields);
        if(empty($errors)){
          ...
          $sql .= " producto_id= '{$p_id}',cantidad={$s_qty},precio='{$s_total}',fecha='{$s_date}'";
          ...
          <th> Acciones</th>
           ...
           <tbody  id="product_info">
              ...
              <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                ...
                <td id="s_qty">
                  <input type="text" class="form-control" name="quantity" value="<?php echo (int)$sale['cantidad']; ?>">
                </td>
                <td id="s_price">
                ...
                <td id="s_date">
                  <input type="date" class="form-control datepicker" name="date" data-date-format="" value="<?php echo remove_junk($sale['fecha']); ?>">
                </td>
                <td>
