<?php
  ...
  $all_groups = find_all('usuarios_grupos');
?>
      ...
      <table class="table table-bordered">
        ...
        <?php foreach($all_groups as $a_group): ?>
          <tr>
           ...
           <td><?php echo remove_junk(ucwords($a_group['grupo_nombre']))?></td>
           <td class="text-center">
             <?php echo remove_junk(ucwords($a_group['grupo_nivel']))?>
           </td>
           <td class="text-center">
           <?php if($a_group['grupo_status'] === '1'): ?>
